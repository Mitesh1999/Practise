...
public class EngFrg extends Fragment implements ActivityTransfer{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.engineering,container,false);
        return view;
    }
    ...
    void getData(){
        ...
        String url = "https://minder.000webhostapp.com/lib/v1/fetch_eng_book_data.php";
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0;i<array.length();i++)
                    {
                      ...
                      String pub_name = object.getString("pub_name");
                       String pub_year = object.getString("pub_year");
                    ...
                    adp = new CustomAdapter(list , getActivity() , EngFrg.this);
